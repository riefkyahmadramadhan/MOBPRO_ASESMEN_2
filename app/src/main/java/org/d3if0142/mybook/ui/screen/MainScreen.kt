...
import org.d3if0142.mybook.navigation.Screen
import org.d3if0142.mybook.ui.theme.MybookTheme
import org.d3if0142.mybook.util.SettingsDataStore
...
fun ScreenContent(showList: Boolean, modifier: Modifier, navController: NavHostController) {
    ...
    if (data.isEmpty()) {
        Column (
            ...
            Image(
                painter = painterResource(R.mipmap.buku),
